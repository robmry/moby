...
// startBuiltinPlugin turns the test binary into an NRI plugin.
// If started successfully, the plugin will be stopped when the test completes.
// Otherwise, the test will fail.
func startBuiltinPlugin(ctx context.Context, t *testing.T, cfg builtinPluginConfig) {
	p := &builtinPlugin{
