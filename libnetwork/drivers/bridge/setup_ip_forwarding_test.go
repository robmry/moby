...
func (f *ffdTestFirewaller) NewNetwork(_ firewaller.NetworkConfig) (firewaller.Network, error) {
	return nil, nil
}
...
func (f *ffdTestFirewaller) FilterForwardDrop(ipv firewaller.IPVersion) error {
	f.ffd = ipv
	return nil
}
