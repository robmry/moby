...
// value of childHostIP from the input.
...
func (n *iptablesNetwork) setPerPortIptables(ctx context.Context, b types.PortBinding, enable bool) error {
	...
	if err := n.setPerPortNAT(v, b, b.HostIP, enable); err != nil {
		return err
	}
...
func (n *iptablesNetwork) setPerPortNAT(ipv iptables.IPVersion, b types.PortBinding, childHostIP net.IP, enable bool) error {
	if b.HostPort == 0 {
		// NAT is disabled.
		return nil
	}
