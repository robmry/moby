...
func (c ChainRef) AppendRuleUf(ctx context.Context, group RuleGroup, rule string, args ...interface{}) (func(context.Context) error, error) {
...
func (v VMapRef) AddElementUf(ctx context.Context, key string, verdict string) (func(context.Context) error, error) {
